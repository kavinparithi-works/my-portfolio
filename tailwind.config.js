  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        hero: ['clamp(48px,7vw,104px)', { lineHeight: '0.98', letterSpacing: '-2px' }],
        'hero-hover': ['clamp(50px,7.2vw,106px)', { lineHeight: '0.98', letterSpacing: '-2px' }],
        ...
        contact: ['clamp(52px,9vw,120px)', { lineHeight: '0.92', letterSpacing: '-2px' }],
